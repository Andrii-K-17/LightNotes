...
<template>
  <div>
    <button
      class="px-5 py-2 w-50 cursor-pointer rounded-lg font-medium transition duration-500 flex items-center justify-center bg-red-600 text-neutral-100 hover:bg-red-500"
